...
Generate a short one sentence tip to help with the condition or fact and statistics about either one of the following conditions that I might find interesting
...
def news(request):
    if request.method=='POST':
        ...
        for i in range(0,len(docs)):
            articles['obj'+str(i+1)]={'title':docs[i]['title'],'url':docs[i]['urlToImage'],'author':docs[i]['author']}
            break
        print(articles)
